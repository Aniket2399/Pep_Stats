...
def test_build_shots_extracts_shot_rows_only():
    ...
    assert (r.shot_end_x, r.shot_end_y) == (120.0, 36.0)
    ...
    assert set(["shot_id","match_id","team_id","team","player_id","player","minute",
                "location_x","location_y","shot_end_x","shot_end_y","shot_statsbomb_xg",
                "outcome","body_part","shot_type","play_pattern","under_pressure"]).issubset(out.columns)
